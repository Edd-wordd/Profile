      ...
      <Container maxWidth="md" sx={{ padding: '2rem 0rem' }}>
        <Grid container direction="row" justify="center">
          <Typography sx={{ lineHeight: '1.5rem', letterSpacing: '.05rem', padding: '0 1.5rem' }}>
            ...
            range of customers. We strive to depart from standard designs and generate unparalleled,
            immersive, and dynamic web encounters. Our commitment is to fashion compelling websites
            that inspire user participation, enhance your web visibility, and foster client
            involvement.
          </Typography>
        </Grid>
      </Container>
