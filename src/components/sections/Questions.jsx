  ...
  return (
    <QuestionsBackground>
      ...
      <Container maxWidth="lg">
        ...
        >
          <Typography variant="h6" sx={{ color: '#f5f5f5', fontWeight: 600, textAlign: 'center' }}>
            If you answered
            <Span>
              <span> YES </span>
            </Span>
            to any of the questions above, don't hesitate to contact us for a consultation on how we
            can help you establish and enhance your digital presence. Our expert team specializes in
            web design, app development, and digital marketing strategies to help you achieve your
            business goals. Consider our comprehensive services to get started on your digital
